...
{
    public abstract class ProcessManagementWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ProcessManagementWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ProcessManagementWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ProcessManagementDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ProcessManagementDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ProcessManagementDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ProcessManagementDbContext, Task<T>> func)
        {
            T result;
